...
# To play the game as it is meant to, remove fA (follower count) from the parameter list, and remove
# x-{str(fA)} from the print() function
def display_info(string, information, fA):
    print(f"{string}: {information} x-{str(fA)}")
...
if entity_A != 0:
    while True:
        ...
        # To play the game as it is meant to, remove follower_count_A (follower count) from the function
        display_info("Compare A", information_A, follower_count_A)
        print(vs)
        ...
        if entity_B != 0:
            ...
            # To play the game as it is meant to, remove follower_count_B (follower count) from the function
